...
const Dashboard = () => {
  ...
  return (
    ...
    <div className=" dashboardBgContainer min-h-screen flex items-center justify-center ">
       <ReactAudioPlayer
        src="Aayi_gaye_.mp3"
        autoPlay
        loop
    ...
    <div className=" flex items-center justify-center h-screen px-4 sm:px-8 md:px-12 lg:px-16  w-11/12 md:9/12 sm:3/6  font-[cursive]">
